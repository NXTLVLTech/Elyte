...
public protocol NLSegmentControlDelegate: class {
...
// MARK: - Public Properties
    ...
    public weak var delegate: NLSegmentControlDelegate?
    ...
    public var selectedTitleTextAttributes: [NSAttributedStringKey : Any] = [
        NSAttributedStringKey(rawValue: NSAttributedStringKey.font.rawValue): UIFont(name: "Helvetica", size: 15) as Any,
...
public extension NLSegmentControl {
    ...
    public func setSelectedSegmentIndex(_ index: Int, animated: Bool) {
        ...
        delegate?.didChangeSegment(toIndex: index)
